package jp.imanaga.camel.doc.parser;
...
public class CamelXmlParser extends DefaultHandler {
	...
	private Stack<List<XmlElement>> cache;
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		XmlElement comopnent = new XmlElement(qName, attrs, childs);
		...
		if (this.cache.size() > 0) {
			this.cache.peek().add(comopnent);
		}

		// キャッシュへ記録
		this.cache.add(childs);
	}
